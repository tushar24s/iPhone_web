...
function Z(t2) {
  const e2 = K ||= new DataView(new ArrayBuffer(8));
...
var bt = [];
function Et(t2) {
  return t2 ? /^\d+$/.test(t2) ? (it(t2), new At($, q)) : null : Tt ||= new At(0, 0);
}
var At = class {
  constructor(t2, e2) {
...
var Tt;
function kt(t2) {
  return t2 ? /^-?\d+$/.test(t2) ? (it(t2), new St($, q)) : null : xt ||= new St(0, 0);
}
var St = class {
  constructor(t2, e2) {
    this.h = t2 >>> 0, this.g = e2 >>> 0;
...
function Re(t2) {
  switch (typeof t2) {
    case "boolean":
      return Ie ||= [0, void 0, true];
    case "number":
      return 0 < t2 ? void 0 : 0 === t2 ? Ce ||= [0, void 0] : [-t2, void 0];
    case "string":
      return [0, t2];
    case "object":
      return t2;
...
function qe(t2, e2, n2 = Jt) {
  if (null != t2) {
    ...
    if (Array.isArray(t2)) {
      var r2 = Xt(t2);
      return 2 & r2 ? t2 : (e2 &&= 0 === r2 || !!(32 & r2) && !(64 & r2 || !(16 & r2)), e2 ? (Yt(t2, -12293 & (34 | r2)), t2) : Ye(t2, qe, 4 & r2 ? Jt : n2, true, false, true));
    }
  ...
  if (!e2) {
    ...
    e2 = i2 ? (t3, e3) => i2(t3, e3, r2) : (t3, e3) => {
      for (; gt(e3) && 4 != e3.h; ) {
        ...
        s2 && s2(e3, t3, i3) || (i3 = (s2 = e3).l, mt(s2), s2.ea ? s2 = void 0 : (o2 = s2.g.g - i3, s2.g.g = i3, s2 = ft(s2.g, o2)), i3 = t3, s2 && (le ||= Symbol(), (o2 = i3[le]) ? o2.push(s2) : i3[le] = [s2]));
      }
      n2 === jn || n2 === Vn || n2.Ja || (t3[fe ||= Symbol()] = n2);
    }, t2[Un] = e2;
  }
  return e2;
}
...
function Hn(t2) {
  ...
  if (!(e2 = Kn(t2, t2[zn] = {}, Xn, Xn, Wn)).ja && !e2.ia) {
    ...
    n2 ? (e2 = Re(t2[0]) === Ie, e2 = t2[zn] = e2 ? Vn ||= { K: Re(true) } : jn ||= {}) : e2.Ja = true;
  }
  return e2;
}
...
function Qn(t2, e2) {
  let n2, r2;
  const i2 = t2.h;
  return (t3, s2, o2) => i2(t3, s2, o2, r2 ||= tr(e2).K, n2 ||= qn(e2));
}
function tr(t2) {
  let e2 = t2[Jn];
...
function rr(t2, e2, n2) {
  const r2 = t2.g;
  let i2, s2;
  return (t3, o2, a2) => r2(t3, o2, a2, s2 ||= ir(e2).K, i2 ||= Nn(e2), n2);
}
function ir(t2) {
  let e2 = t2[er];
...
var wr = ar(function(t2, e2, n2) {
  ...
  null != (e2 = me(e2)) && (It(t2, n2, 1), t2 = t2.g, (n2 = K ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e2, true), $ = n2.getUint32(0, true), q = n2.getUint32(4, true), Ot(t2, $), Ot(t2, q));
});
...
function yo(t2) {
  ...
  if ((e2 = _n(t2, Ui, 4)?.h()) && (s2.boundingBox = { originX: Sn(e2, 1) ?? 0, originY: Sn(e2, 2) ?? 0, width: Sn(e2, 3) ?? 0, height: Sn(e2, 4) ?? 0, angle: 0 }), _n(t2, Ui, 4)?.g().length) for (const e3 of _n(t2, Ui, 4).g()) s2.keypoints.push({ x: on(e3, 1) ?? 0, y: on(e3, 2) ?? 0, score: on(e3, 4) ?? 0, label: xn(e3, 3) ?? "" });
  return s2;
}
function vo(t2) {
  const e2 = [];
...
var jo = class {
  ...
  l(t2, e2 = true) {
    if (e2) {
      ...
      if (!(_n(this.baseOptions, ms, 1)?.g() || _n(this.baseOptions, ms, 1)?.h() || t2.baseOptions?.modelAssetBuffer || t2.baseOptions?.modelAssetPath)) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
      if (function(t3, e4) {
...
function $o(t2) {
  t2.h?.bindFramebuffer(t2.h.FRAMEBUFFER, null);
}
var qo = class {
  close() {
    if (this.g) {
...
var pa = class {
  ...
  close() {
    this.h?.close(), this.h = void 0, this.l?.close(), this.l = void 0;
  }
};
function ga(t2, e2) {
  switch (e2) {
...
function Oa(t2, e2, n2, r2) {
  if (t2.da) {
    ...
    if (n2?.rotationDegrees) {
      if (0 != n2?.rotationDegrees % 90) throw Error("Expected rotation to be a multiple of 90°.");
      if (Pn(s2, 5, -Math.PI * n2.rotationDegrees / 180), 0 != n2?.rotationDegrees % 180) {
...
var tc = class extends Ra {
  ...
  o(t2) {
    if (On(this.h, 3, t2.numHands ?? 1), "minHandDetectionConfidence" in t2 && Pn(this.h, 2, t2.minHandDetectionConfidence ?? 0.5), "minTrackingConfidence" in t2 && Pn(this.C, 4, t2.minTrackingConfidence ?? 0.5), "minHandPresenceConfidence" in t2 && Pn(this.u, 2, t2.minHandPresenceConfidence ?? 0.5), t2.cannedGesturesClassifierOptions) {
      var e2 = new Cs(), n2 = go(t2.cannedGesturesClassifierOptions, _n(this.j, Cs, 3)?.h());
      En(e2, 0, 2, n2), En(this.j, 0, 3, e2);
    } else void 0 === t2.cannedGesturesClassifierOptions && _n(this.j, Cs, 3)?.g();
    return t2.customGesturesClassifierOptions ? (En(e2 = new Cs(), 0, 2, n2 = go(t2.customGesturesClassifierOptions, _n(this.j, Cs, 4)?.h())), En(this.j, 0, 4, e2)) : void 0 === t2.customGesturesClassifierOptions && _n(this.j, Cs, 4)?.g(), this.l(t2);
  }
  Ka(t2, e2) {
...
var rc = class extends Ra {
  ...
  m() {
    ...
    ui(n2, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), li(n2, "IMAGE:input_image"), li(n2, "NORM_RECT:norm_rect"), fi(n2, "CLASSIFICATIONS:classifications"), n2.o(e2), _i(t2, n2), this.g.attachProtoListener("classifications", (t3, e3) => {
      this.j = function(t4) {
        const e4 = { classifications: bn(t4, Qi, 1).map((t5) => mo(_n(t5, Fi, 4)?.g() ?? [], Fn(Sn(t5, 2)), xn(t5, 3) ?? "")) };
      ...
      t3 = hs(t3), this.embeddings = function(t4) {
        return { embeddings: bn(t4, ss, 1).map((t5) => {
          ...
          if (void 0 !== vn(t5, rs, gn(t5, 1))) t5 = cn(t5 = _n(t5, rs, gn(t5, 1)), 1, me), e4.floatEmbedding = t5;
            ...
            e4.quantizedEmbedding = _n(t5, is, gn(t5, 2))?.oa()?.qa() ?? n3;
          }
          return e4;
...
var cc = class extends Ra {
  ...
  V() {
    !function(t2) {
      ...
      1 === e2.length && (_n(e2[0], ni, 7)?.l()?.g() ?? /* @__PURE__ */ new Map()).forEach((e3, n2) => {
...
//# sourceMappingURL=vision_bundle-AT5O5D7G.js.map
